...
exports.command = {
    version: {
        usage: 'watchdog version | watchdog --version | watchdog -v',
    ...
    help: {
        usage: 'watchdog help | watchdog --help | watchdog -h',
        description: '打印使用信息',
        run: function () {
            console.log('所有可用的命令：\n');
    ...
    init: {
        ...
        run: function () {
            ...
            if (fs.existsSync(outputFilePath)) {
                console.log(
                    'The config file is existed: %s.', chalk.green(outputFilePath)
                );
                return;
            }
            ...
            fs.readFile(
                ...
                function (err, data) {
                    ...
                    console.log('Init done, config file: %s', chalk.green(outputFilePath));
                }
            );
        }
    },
